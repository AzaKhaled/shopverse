    ...
    return BlocBuilder<HomeCubit, HomeStates>(
      buildWhen: (prev, current) {
        return current is GetProductsLoadingState ||
            ...
            current is ToggleDarkModeState ||
            current is ToggleLanguageState;
      },
      builder: (context, state) {
        ...
        if (state is GetProductsSuccessState &&
            homeCubit.productsModel!.products.isEmpty) {
          return Center(
            child: Text(
        ...
        if (state is GetProductsSuccessState) {
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () {
                  homeCubit.getProductDetails(productId: product.id ?? 0);
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      (product.isOnSale ?? false)
                                          ? '\$${NumberFormat('#,##0').format(double.parse(product.price ?? '0'))}'
                                          : '',
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
